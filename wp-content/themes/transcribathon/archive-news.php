...
<section id="primary-full-width" class="content-area">
	<div id="content" class="site-content" role="main">

		<header class="page-header" style="margin-top: 3em;">
			<h1 id="page-title"><?php echo _x('News','Title on the News-Archive','transcibathon'); ?></h1>
			<?php
			if ( is_category() ) {
		...
		<?php get_template_part( 'loops/loop-news', siteorigin_setting('blog_archive_layout') ) ?>
