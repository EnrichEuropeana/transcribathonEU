...
function _TCT_item_page_test_iiif( $atts ) {  
    if (isset($_GET['id']) && $_GET['id'] != "") {
        ...
        $editorTab = "";
            ...
            $editorTab .= '<div class="panel panel-default">';
                $editorTab .= '<div class="panel-heading clickable" data-toggle="collapse" href="#transcription-history">';
                    $editorTab .= '<h4 id="transcription-history-collapse-heading" class="theme-color item-page-section-headline panel-title">';  
                        $editorTab .= "TRANSCRIPTION HISTORY";
                    $editorTab .= '</h4>';
                    $editorTab .= '<i class="fa fa-angle-down" style="font-size: 20px; float:right;"></i>';
                $editorTab .= '</div>';
                $editorTab .= "<div id=\"transcription-history\" class=\"transcription-history-area panel-body panel-collapse collapse\">";
                $i = 0;
        ...
        // Comment section
        $commentSection = "";
        $commentSection .= '<div class="panel panel-default">';
            $commentSection .= '<div class="panel-heading clickable" data-toggle="collapse" href="#comments">';
                $commentSection .= '<h4 id="comments-collapse-heading" class="theme-color item-page-section-headline panel-title">';  
                    $commentSection .= "NOTES AND QUESTIONS";
                $commentSection .= '</h4>';
                $commentSection .= '<i class="fa fa-angle-down" style="font-size: 20px; float:right;"></i>';
            $commentSection .= '</div>';
            $commentSection .= "<div id=\"comments\" class=\"comments-area panel-body panel-collapse collapse\">";
...
$content .= "<script>
            ...
            $content .= "<div id='full-view-right'>";
                ...
                $content .= "<hr>";
                $content .= '<div class="panel panel-default">';
                    $content .= '<div class="panel-heading clickable" data-toggle="collapse" href="#enrichment-collapsable">';
                        $content .= '<h4 id="info-collapse-heading" class="theme-color item-page-section-headline panel-title">'; 
                                $content .= 'AUTOMATIC ENRICHMENTS';
                            $content .= '</h4>';
                        $content .= '<i class="fa fa-angle-down" style="font-size: 20px; float:right;"></i>';
                    $content .= '</div>';
                    $content .= '<div id="enrichment-collapsable" class="panel-body panel-collapse collapse">';
                        $content .= "<div id='full-view-enrichment'>";
