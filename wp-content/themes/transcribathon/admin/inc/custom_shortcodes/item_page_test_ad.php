            ...
            $editorTab .= '<div class="item-page-section">';
                ...
                $editorTab .= '<div style="clear: both;"></div>';
                    $editorTab .= "<div id=\"description-area\" class=\"description-save description-history-area collapse show\">";
                        ...
                        $editorTab .= '<div size="5" id= "description-language-selector" class="theme-color-background description-lang-select language-selector">';
                        $editorTab .= '<select>';
                        ...
                        $editorTab .= '<script>
                                        ...
                                        /*look for any elements with the class "description-lang-select":*/
                                        x = document.getElementsByClassName("description-lang-select");
                        ...
                        $taggingTab .= '<div id="location-data-output-'.$place['PlaceId'].'" class="collapse">';
                            $taggingTab .= '<div id="location-data-output-display-'.$place['PlaceId'].'" class="location-data-output-content">';
                                ...
                                $taggingTab .= '<i class="edit-item-data-icon fas fa-pencil theme-color-hover" 
                                                    onClick="editLocation('.$place['PlaceId'].')"></i>';
                            ...
                            $taggingTab .= '<div id="location-data-edit-'.$place['PlaceId'].'" class="location-data-edit-container">';
                                ...
                                $taggingTab .= "<div>";
                                    ...
                                    $taggingTab .= "<button id='save-personinfo-button' class='theme-color-background person-edit-data-cancel' onClick='editLocation(".$place['PlaceId'].")'>";
                                        $taggingTab .= "CANCEL";
                                    $taggingTab .= "</button>";
                               ...
                               $taggingTab .= '<li id="person-'.$person['PersonId'].'">';
                                    $taggingTab .= '<div class="item-data-output-element-header">';
                                        $taggingTab .= '<h6 class="person-data-ouput-headline collapse-controller" data-toggle="collapse" href="#person-data-output-'.$person['PersonId'].'">';
                                            $taggingTab .= $firstName.', '.$lastName.' ('.$birthDate.'-'.$deathDate.')';
                                        $taggingTab .= '</h6>';
                                        $taggingTab .= '<i class="fas fa-angle-down" style= "float:right;"></i>';
                                        $taggingTab .= '<div style="clear:both;"></div>';
                                    $taggingTab .= '</div>';
                                        ...
                                        $taggingTab .= '<div class="person-data-edit-container person-item-data-container" id="person-data-edit-'.$person['PersonId'].'">';
                                            $taggingTab .= '<div id="person-input-names-container">';
                                                $taggingTab .= '<input type="text" id="person-firstName-input" class="person-input-field" value="'.$firstName.'" style="outline:none;">';
                                                $taggingTab .= '<input type="text" id="person-lastName-input" class="person-input-field" value="'.$lastName.'">';
                                            $taggingTab .= '</div>'; 
    
                                            $taggingTab .= '<div id="person-location-birth-inputs">';
                                                $taggingTab .= '<input type="text" id="person-birthPlace-input"   class="person-input-field" value="'.$birthPlace.'">';
                                                $taggingTab .= '<input type="text" id="person-birthDate-input" class="person-input-field" value="'.$birthDate.'">';
                                            $taggingTab .= '</div>'; 
    
                                            $taggingTab .= '<div id="person-location-death-inputs">';
                                                $taggingTab .= '<input type="text" id="person-deathPlace-input" class="person-input-field" value="'.$deathPlace.'">';
                                                $taggingTab .= '<input type="text" id="person-deathDate-input" class="person-input-field" value="'.$deathDate.'">';
                                            $taggingTab .= '</div>';    
    
                                            $taggingTab .= '<div id="person-description-input">';
                                                $taggingTab .= '<label>Additional description:</label><br/>';
                                                $taggingTab .= '<input type="text" class="person-input-field" value="'.$description.'">';
                                            $taggingTab .= '</div>';
                ...
                $content .= "<div id='item-data-header'>";
                    ...
                    $content .= '<div class="view-switcher" id="switcher-casephase">';
                        $content .= '<ul id="item-switch-list" class="switch-list">';
                            ...
                            $content .= "<li>";
                                $content .= '<i id="horizontal-split" class="fas fa-window-minimize view-switcher-icons theme-color"
