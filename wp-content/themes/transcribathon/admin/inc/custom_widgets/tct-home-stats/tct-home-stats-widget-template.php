...
echo "<div style=\"text-align: center\" class=\"home-stats-content section group\">\n";
	echo "<div class=\"column-rgs span_1_of_3\">\n";
		echo "<div class=\"stat-number\">\n";
			echo "<h3 class=\"theme-color\">".strrev(chunk_split(strrev($items) , 3 , ' '))."  <span>Documents</span></h3>\n";
		echo "</div>\n"; 
	echo "</div>\n";
	echo "<div class=\"column-rgs span_1_of_3\">\n";
		echo "<div class=\"stat-number\">\n";
			echo "<h3 class=\"theme-color\"> ".strrev(chunk_split(strrev($characters) , 3 , ' '))." <span>Characters</span></h3>\n";
		echo "</div>\n";
	echo "</div>\n";
	echo "<div class=\"column-rgs span_1_of_3\">\n";
		echo "<div class=\"stat-number\">\n";
			echo "<h3 class=\"theme-color\">".strrev(chunk_split(strrev($enrichments) , 3 , ' '))."  <span>Enrichments</span></h3>\n";
		echo "</div>\n";
	echo "</div>\n";
echo "</div>\n";
