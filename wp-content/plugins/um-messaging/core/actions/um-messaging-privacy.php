	...
	***/
	...
	function um_messaging_privacy_setting() {
		...
		$options = array(
                      ...
                      "followed" 	=> __('Only people I follow','um-messaging'),
                      "follower" 	=> __('Followers','um-messaging')
		);
		...
		<div class="um-field" data-key="">
			...
			<div class="um-field-area">
				...
				<select name="_pm_who_can" id="_pm_who_can" data-validate="" data-key="_pm_who_can" class="um-form-field valid um-s2 " style="width: 100%" data-placeholder="">
					...
					<?php if ( defined('um_friends_extension') ) { ?>
					<option value="friends"  <?php selected('friends', $_pm_who_can ); ?>><?php _e('Friends','um-messaging'); ?></option>
					<?php } ?>
	...
	add_filter('um_predefined_fields_hook', 'um_messaging_account_privacy_fields_add');
